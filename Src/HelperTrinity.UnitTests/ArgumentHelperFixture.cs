namespace HelperTrinity.UnitTests
{
    ...
    public sealed class ArgumentHelperFixture
    {
        ...
        public void assert_enum_member_throws_if_zero_flag_enumeration_value_is_passed_in_but_it_is_not_a_valid_value()
        {
            ...
            Assert.Equal(string.Format(CultureInfo.InvariantCulture, "Enum value 'None' is not valid for flags enumeration 'HelperTrinity.UnitTests.ArgumentHelperFixture+FlagsEnum'.{0}Parameter name: test", Environment.NewLine), ex.Message);
        }
